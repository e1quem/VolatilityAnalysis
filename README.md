...
$$\sigma^2_{rs}=\frac{1}{n}\sum^n_{i=1} \left( \log\quad\left(\frac{H_i}{C_i}\right) \log\left(\frac{H_i}{O_i}\right) + \log\left(\frac{L_i}{C_i}\right) \log\left(\frac{L_i}{O_i}\right) \right)$$
